...
function initApplicableUsersMultiselect($elements, userListLimit) {
	...
	return $elements.select2({
		...
		ajax: {
			url: OC.generateUrl('apps/files_external1/applicable'),
			dataType: 'json',
			quietMillis: 100,
...
// Keep this in sync with \OCA\Files_External1\MountConfig::STATUS_*
...
GlobalStorageConfig.prototype = _.extend({}, StorageConfig.prototype,
	...
	_url: 'apps/files_external1/globalstorages',
...
UserStorageConfig.prototype = _.extend({}, StorageConfig.prototype,
	...
	_url: 'apps/files_external1/userstorages'
});
...
UserGlobalStorageConfig.prototype = _.extend({}, StorageConfig.prototype,
	...
	_url: 'apps/files_external1/userglobalstorages'
});
...
MountConfigListView.prototype = _.extend({
	...
	loadStorages: function() {
		...
		if (this._isPersonal) {
			...
			$.ajax({
				type: 'GET',
				url: OC.generateUrl('apps/files_external1/userglobalstorages'),
				data: {'testOnly' : true},
				contentType: 'application/json',
				success: function(result) {
					var onCompletion = jQuery.Deferred();
	...
	$('#global_credentials').on('submit', function() {
		...
		$.ajax({
			...
			data: JSON.stringify({
				...
				url: OC.generateUrl('apps/files_external1/globalcredentials'),
				dataType: 'json',
			success: function() {
