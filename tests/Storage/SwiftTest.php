 ...
 *
 */
namespace OCA\Files_External1\Tests\Storage;

use GuzzleHttp\Exception\ClientException;
use OCA\Files_External1\Lib\Storage\Swift;
 ...
 * @group DB
 *
 * @package OCA\Files_External1\Tests\Storage
 */
class SwiftTest extends \Test\Files\Storage\Storage {
	...
	protected function setUp(): void {
		...
		$this->config = include('files_external1/tests/config.swift.php');
