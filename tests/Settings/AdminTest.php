 ...
 *
 */
namespace OCA\Files_External1\Tests\Settings;
...
use OCA\Files_External1\Settings\Admin;
...
class AdminTest extends TestCase {
	...
	public function testGetForm() {
		...
		$params = [
			...
			'dependencies' => \OCA\Files_External1\MountConfig::dependencyMessage($this->backendService->getBackends()),
