...
abstract class CommandTest extends TestCase {
	 ...
	 * @return \OCA\Files_External1\Service\GlobalStoragesService|\PHPUnit\Framework\MockObject\MockObject
	 */
	protected function getGlobalStorageService(array $mounts = []) {
		$mock = $this->getMockBuilder('OCA\Files_External1\Service\GlobalStoragesService')
