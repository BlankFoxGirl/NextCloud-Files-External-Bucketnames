 ...
 *
 */
namespace OCA\Files_External1\Tests\Controller;

use OCA\Files_External1\Controller\GlobalStoragesController;
use OCA\Files_External1\Lib\Auth\AuthMechanism;
use OCA\Files_External1\Lib\Backend\Backend;

use OCA\Files_External1\Lib\StorageConfig;
use OCA\Files_External1\NotFoundException;
use OCA\Files_External1\Service\GlobalStoragesService;
use OCA\Files_External1\Service\UserStoragesService;
...
abstract class StoragesControllerTest extends \Test\TestCase {
	...
	protected function setUp(): void {
		\OCA\Files_External1\MountConfig::$skipTest = true;
	}

	protected function tearDown(): void {
		\OCA\Files_External1\MountConfig::$skipTest = false;
	}

	/**
	 * @return \OCA\Files_External1\Lib\Backend\Backend|MockObject
	 */
	protected function getBackendMock($class = '\OCA\Files_External1\Lib\Backend\SMB', $storageClass = '\OCA\Files_External1\Lib\Storage\SMB') {
	...
	/**
	 * @return \OCA\Files_External1\Lib\Auth\AuthMechanism|MockObject
	 */
	protected function getAuthMechMock($scheme = 'null', $class = '\OCA\Files_External1\Lib\Auth\NullMechanism') {
	...
	public function testAddStorage() {
		...
		$response = $this->controller->create(
			'mount',
			'\OCA\Files_External1\Lib\Storage\SMB',
			'\OCA\Files_External1\Lib\Auth\NullMechanism',
			[],
			[],
			[],
			[],
