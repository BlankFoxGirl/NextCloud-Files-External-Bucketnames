 ...
 *
 */
namespace OCA\Files_External1\Tests\Backend;

use OCA\Files_External1\Lib\Backend\LegacyBackend;
use OCA\Files_External1\Lib\DefinitionParameter;
use OCA\Files_External1\Lib\MissingDependency;
...
class LegacyBackendTest extends \Test\TestCase {
	...
	public function testConstructor() {
		$auth = $this->getMockBuilder('\OCA\Files_External1\Lib\Auth\Builtin')
			->disableOriginalConstructor()
			->getMock();

		$class = '\OCA\Files_External1\Tests\Backend\LegacyBackendTest';
		$definition = [
			'configuration' => [
		...
		$this->assertEquals('\OCA\Files_External1\Tests\Backend\LegacyBackendTest', $backend->getStorageClass());
