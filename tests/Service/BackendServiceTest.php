 ...
 *
 */
namespace OCA\Files_External1\Tests\Service;

use OCA\Files_External1\Config\IConfigHandler;
...
class BackendServiceTest extends \Test\TestCase {
	 ...
	 * @param string $class
	 *
	 * @return \OCA\Files_External1\Lib\Backend\Backend|\PHPUnit\Framework\MockObject\MockObject
	 */
	 ...
	 * @param string $class
	 *
	 * @return \OCA\Files_External1\Lib\Auth\AuthMechanism|\PHPUnit\Framework\MockObject\MockObject
	 */
	...
	public function testRegisterBackend() {
		...
		/** @var \OCA\Files_External1\Lib\Backend\Backend|\PHPUnit\Framework\MockObject\MockObject $backendAlias */
	...
	public function testGetAvailableBackends() {
		...
		$backendNotAvailable->expects($this->once())
			->method('checkDependencies')
			->willReturn([
				$this->getMockBuilder('\OCA\Files_External1\Lib\MissingDependency')
					->disableOriginalConstructor()
					->getMock()
			]);
