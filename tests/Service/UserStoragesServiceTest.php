...
use OCA\Files_External1\Service\StoragesService;
...
class UserStoragesServiceTest extends StoragesServiceTest {
	...
	private function makeTestStorageData() {
		return $this->makeStorageConfig([
			...
			'backendIdentifier' => 'identifier:\OCA\Files_External1\Lib\Backend\SMB',
	...
	public function testAddStorage() {
		...
		$this->assertHookCall(
			...
			\OCA\Files_External1\MountConfig::MOUNT_TYPE_USER,
			$this->userId
		);
	...
	public function testGetAdminStorage() {
		$this->expectException(\OCA\Files_External1\NotFoundException::class);

		$backend = $this->backendService->getBackend('identifier:\OCA\Files_External1\Lib\Backend\SMB');
		...
		$this->assertInstanceOf('\OCA\Files_External1\Lib\StorageConfig', $this->globalStoragesService->getStorage($newStorage->getId()));
