...
class GlobalAuthTest extends TestCase {
	...
	private function getStorageConfig($type, $config = []) {
		/** @var \OCA\Files_External1\Lib\StorageConfig|\PHPUnit\Framework\MockObject\MockObject $storageConfig */
	...
	public function testNoCredentialsPersonal() {
		$this->expectException(\OCA\Files_External1\Lib\InsufficientDataForMeaningfulAnswerException::class);
