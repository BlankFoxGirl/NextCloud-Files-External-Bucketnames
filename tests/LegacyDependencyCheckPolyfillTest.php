 ...
 *
 */
namespace OCA\Files_External1\Tests;
...
class LegacyDependencyCheckPolyfillTest extends \Test\TestCase {
	...
	public function testCheckDependencies() {
		$trait = $this->getMockForTrait('\OCA\Files_External1\Lib\LegacyDependencyCheckPolyfill');
		$trait->expects($this->once())
			->method('getStorageClass')
			->willReturn('\OCA\Files_External1\Tests\LegacyDependencyCheckPolyfillTest');
