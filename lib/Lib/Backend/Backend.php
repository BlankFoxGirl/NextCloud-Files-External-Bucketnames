...
use OCA\Files_External1\Lib\DependencyTrait;
use OCA\Files_External1\Lib\FrontendDefinitionTrait;
use OCA\Files_External1\Lib\IdentifierTrait;
use OCA\Files_External1\Lib\IFrontendDefinition;
use OCA\Files_External1\Lib\IIdentifier;
use OCA\Files_External1\Lib\PriorityTrait;
use OCA\Files_External1\Lib\StorageConfig;
use OCA\Files_External1\Lib\StorageModifierTrait;
use OCA\Files_External1\Lib\VisibilityTrait;
